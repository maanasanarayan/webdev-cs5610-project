...
import { changeFirstName, changeLastName, changeGender, changePhoneNumber, changeDateOfBirth, changeAddress } from "../reducers/user-reducer";
...
console.log(user);
    ...
    let [phonenumber, setPhoneNumber] = useState({ phonenumber: user.phonenumber });
        ...
        <div className="profileContainer">
            ...
            <Form>
                <div class="row">
                    <div class="col-md-6">
                        <Form.Group className="mb-3" controlId="firstName">
                            ...
                            <Form.Control value={user.username} type="text" disabled={isDisabled} />
                            <Form.Text value={user.username} className="text-muted">
                    ...
                    <div class="col-md-6">
                        <Form.Group className="mb-3" controlId="lastName">
                            ...
                            <Form.Control value={user.lname} type="text" disabled={isDisabled} />
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <Form.Group className="mb-3 formValues" controlId="firstName">
                            ...
                            <Form.Control value={user.gender} type="text" disabled={isDisabled}/>
                            <Form.Text className="text-muted">
                    ...
                    <div class="col-md-6">
                        <Form.Group className="mb-3" controlId="date">
                            ...
                            <Form.Control value={user.phonenumber} type="text" disabled={isDisabled}/>
                            <Form.Text className="text-muted">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <Form.Group className="mb-3" controlId="date">
                            ...
                            <Form.Control value={user.dob} type="date" disabled={isDisabled}/>
                            <Form.Text className="text-muted">
                    ...
                    <div class="col-md-6 ">
                        <Form.Group className="mb-3" controlId="date">
                            ...
                            <Form.Control value={user.address} type="text" disabled={isDisabled}/>
                            <Form.Text className="text-muted">
                ...
                <div class="row">
                    ...
                    <button className="btn btn-secondary btn-block rounded-pill"
                            onClick={saveProfile}>
                        Save
                    </button>
                    </div>
